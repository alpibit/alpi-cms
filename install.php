        ...
        <div class="alpi-card">
            ...
            <form method="post" class="alpi-form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8'); ?>">
                ...
                <div class="alpi-form-group">
                    ...
                    <input type="text" name="db_host" id="db_host" class="alpi-form-input" required value="<?php echo $host; ?>">
                </div>
                <div class="alpi-form-group">
                    <label for="db_name" class="alpi-form-label">Database Name</label>
                    <input type="text" name="db_name" id="db_name" class="alpi-form-input" required value="<?php echo $name; ?>">
                </div>
                <div class="alpi-form-group">
                    <label for="db_user" class="alpi-form-label">Database User</label>
                    <input type="text" name="db_user" id="db_user" class="alpi-form-input" required value="<?php echo $user; ?>">
                </div>
                <div class="alpi-form-group">
                ...
                <div class="alpi-form-group">
                    ...
                    <input type="email" name="admin_email" id="admin_email" class="alpi-form-input" required value="<?php echo $adminEmail; ?>">
                </div>
                <div class="alpi-form-group">
                    <label for="admin_user" class="alpi-form-label">Admin Username</label>
                    <input type="text" name="admin_user" id="admin_user" class="alpi-form-input" required value="<?php echo $adminUser; ?>">
                </div>
                <div class="alpi-form-group">
                ...
                <div class="alpi-form-group">
                    ...
                    <input type="url" name="website_url" id="website_url" class="alpi-form-input" required value="<?php echo $websiteUrl; ?>">
                </div>
                ...
                <div class="alpi-form-group">
                    ...
                    <input type="text" name="email_smtp_host" id="email_smtp_host" class="alpi-form-input" value="<?php echo $email_smtp_host; ?>">
                </div>
                <div class="alpi-form-group">
                    <label for="email_smtp_port" class="alpi-form-label">SMTP Port</label>
                    <input type="number" name="email_smtp_port" id="email_smtp_port" class="alpi-form-input" value="<?php echo $email_smtp_port; ?>">
                </div>
                <div class="alpi-form-group">
                    <label for="email_smtp_username" class="alpi-form-label">SMTP Username</label>
                    <input type="text" name="email_smtp_username" id="email_smtp_username" class="alpi-form-input" value="<?php echo $email_smtp_username; ?>">
                </div>
                <div class="alpi-form-group">
