...
class BlockData
{
    private const FIELD_DEFINITIONS = [
        ...
        'title_size_desktop' => ['default' => '', 'pdo' => PDO::PARAM_STR],
        'title_size_tablet' => ['default' => '', 'pdo' => PDO::PARAM_STR],
        'title_size_mobile' => ['default' => '', 'pdo' => PDO::PARAM_STR],
        'content_size_desktop' => ['default' => '', 'pdo' => PDO::PARAM_STR],
        'content_size_tablet' => ['default' => '', 'pdo' => PDO::PARAM_STR],
        'content_size_mobile' => ['default' => '', 'pdo' => PDO::PARAM_STR],
