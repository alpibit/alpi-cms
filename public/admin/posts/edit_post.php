...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($_POST['blocks'] as $index => $block) {
        ...
        $blockData = [
            ...
            'transition_effect' => $block['transition_effect'] ?? '',
            ...
            'background_type_desktop' => $block['background_type_desktop'] ?? '',
            'background_type_tablet' => $block['background_type_tablet'] ?? '',
            'background_type_mobile' => $block['background_type_mobile'] ?? '',
